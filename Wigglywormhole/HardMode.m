...
-(IBAction)CountDown
{
    ...
    if (TimeRemain==0) {
        ...
        TimeRemain = 3;
        snakeMovement = [NSTimer scheduledTimerWithTimeInterval:0.3 target:self selector:@selector(snakeMove) userInfo:nil repeats:YES];
...
-(void)ScoreShow
{
    ...
    _ScoreLabel.text = [NSString stringWithFormat:@"%i",Score*20];
}
