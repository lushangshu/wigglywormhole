...
-(void)TextFieldGet
{
    NSString *txf = [_gameOverAlert textFieldAtIndex:0].text;
    NSLog(@"########## %@",txf);
}

-(void)GameOver
{
    NSString *overMesg = [NSString stringWithFormat:@"You scored: %d \n Please input your name" , Score*10];
    //UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oh no, you died!" message:overMesg delegate:self cancelButtonTitle:@"cancel" otherButtonTitles:@"ok",nil];
    _gameOverAlert = [[UIAlertView alloc] initWithTitle:@"Oh no, you died!" message:overMesg delegate:self cancelButtonTitle:@"cancel" otherButtonTitles:@"ok", nil];
    //[[alert alertViewStyle] UIAlertViewStylePlainTextInput ];
    [_gameOverAlert setAlertViewStyle:UIAlertViewStylePlainTextInput];
    nameTextfield = [[UITextField alloc]initWithFrame:CGRectMake(12, 45, 50, 25)];
    //[nameTextfield setBackground:[UIColor whiteColor]];
    [_gameOverAlert addSubview:nameTextfield];
    [_gameOverAlert show];
...
-(void)ScoreShow
{
    ...
    _ScoreLabel.text = [NSString stringWithFormat:@"%i",Score*10];
}
...
-(void)snakeMove
{
    ...
    for (int i = ((int)[snakeBodyArray count]-1); i>-1; i--)
    {
